...
<link rel="stylesheet" type="text/css" href="papaya/release/current/standard/papaya.css?build=1432" />
<script type="text/javascript" src="papaya/release/current/standard/papaya.js?build=1432"></script>
...
<!-- # ```{r echo=FALSE,message=FALSE,warning=FALSE,out.width=400,out.height=400} -->
<!-- #   require(vembedr) -->
<!-- #   require(htmltools) -->
<!-- #   embed_youtube(id = "8FUjjvmPsho") -->
<!-- # ``` -->
...
<script type="text/javascript">
    ...
    params["images"] = ["ROIs/single_subj_T1.nii", "ROIs/rAMY_L_mask.nii", "ROIs/rAMY_R_mask.nii", "ROIs/rHIPP_BODY_L_mask.nii", "ROIs/rHIPP_BODY_R_mask.nii", "ROIs/rPRC_L_mask.nii", "ROIs/rPRC_R_mask.nii", "ROIs/rPHC_ANT_L_mask.nii", "ROIs/rPHC_ANT_R_mask.nii"];
    ...
    params["rPRC_L_mask.nii"]  = {lut:"Bluea"};
    params["rPRC_R_mask.nii"]  = {lut:"Blueb"};
    params["rPHC_ANT_L_mask.nii"]  = {lut:"Purplea"};
    params["rPHC_ANT_R_mask.nii"]  = {lut:"Purpleb"};
