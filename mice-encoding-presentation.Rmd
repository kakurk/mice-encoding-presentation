...
- Past research suggests that the **Caudate Nucleus** is active when encountering a threatening context.
    - Threat of shock, Uncertainty
- Perhaps others brain areas?
    - TEXT TEXT TEXT
...
- Past research implicates the **Perirhinal Cortex** in the encoding and retrieval of item information  
    - Faces, pictures, objects, task-relevant  
